...
console.log(`"" == false: ${"" == false}`); // Igual podendo ser string e number //
console.log(`"" === false: ${"" === false}`); // Exatamente Iguais até os objetos //
...
const x = "Maria";
const y = "Maria";
const a = new String("Maria"); // Função construtora //
...
console.log(`(10 > 5) || (10 > 20): ${(10 > 5) || (10 > 20)}`); // OU ( Basta 1 ser Verdadeiro para ser True ) //
console.log(`(10 < 5) || (10 > 20): ${(10 > 5) && (10 > 20)}`);
console.log(`!(10 > 5): ${!(10 > 5)}`); // NAO ( Inverte de Verdadeiro para Falso ) //